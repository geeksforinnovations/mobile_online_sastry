...
import { Container, Content, Text, Button, Icon, Body, Input, View, H3, Footer, 
  FooterTab, Card, CardItem ,Spinner} from 'native-base';
        ...
        <Content style={{ margin: 10 }}>
          ...
          <Card>
            ...
            <CardItem bordered>
              <Body>
                ...
                <View style={{ flex: 1, width: '100%', marginTop: 15 }}>
                  ...
                  <Input placeholderTextColor='#e69b3a' style={{ borderColor: '#e69b3a', color: '#e69b3a', borderWidth: 1, flex: 1, width: '100%' }}
                    type="email-address"
            ...
            <CardItem footer bordered>
              <Text>Amount to be paid: {this.props.selectedPuja.localCost}</Text>
            </CardItem>
          </Card>

          {this.state.showLoader ? <Spinner style={{marginTop:30}} color="#e69b3a" /> : null}
        </Content>
        <Footer>
          <FooterTab>
            <Button
