...
import { Container, Header, Content, Picker, H3, Button, Text, View } from "native-base";
    ...
    render() {
        ...
        return (
            <>
                ...
                <G4IHeader title={'Filter'} {...this.props} onRightClick={this.OpenFilter}></G4IHeader>
                    ...
                    <Container style={{ margin: 10 }} >
                        ...
                        <Content>
                            ...
                            <View style={{ marginTop: 40 }}>
                                <Button block onPress={() => this.props.navigation.goBack(null)}>
